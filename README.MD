...
- 🪪 **Labels** – Button labels are rendered directly on each pad; edit your soundboard JSON labels or tweak the `.pad-meta` rules to adjust typography or styling.
...
│       ├── soundboard_cli.py   # MemeDeck Live CLI
